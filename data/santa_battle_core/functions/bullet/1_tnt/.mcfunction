...
# 着弾
    execute as @a[distance=..4] unless entity @s[tag=Player.GhostTeam] unless entity @s[gamemode=spectator] unless score @s player.invulnerable_timer matches 1.. run tag @s add Temp.Hit
