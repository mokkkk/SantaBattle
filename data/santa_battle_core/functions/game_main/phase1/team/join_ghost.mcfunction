#> santa_battle_core:game_main/phase1/team/join_ghost
#
# ロビーのtick処理
...
# 通知
    ...
    title @s actionbar [{"text": "【","color": "white","bold": true},{"text": "観戦者","color": "white","bold": true},{"text":"に加入しました】","color": "white","bold": true}]
