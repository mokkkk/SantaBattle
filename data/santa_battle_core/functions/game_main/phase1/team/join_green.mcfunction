#> santa_battle_core:game_main/phase1/team/join_green
#
# ロビーのtick処理
...
# 通知
    ...
    title @a actionbar [{"text": "【","color": "white","bold": true},{"text": "緑チーム","color": "green","bold": true},{"text":"に加入しました】","color": "white","bold": true}]
