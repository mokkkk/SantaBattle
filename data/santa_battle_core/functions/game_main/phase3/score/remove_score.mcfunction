...
# 優勝者更新
    execute unless score #game_manager game.setting.is_team matches 1.. as @a[tag=!Player.Ghost] run function santa_battle_core:game_main/phase3/score/update_winner
    execute if score #game_manager game.setting.is_team matches 1.. as @a[tag=!Player.Ghost] run function santa_battle_core:game_main/phase3/score/update_winner_team
