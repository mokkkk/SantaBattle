...
# プレイヤー数を元に角度計算
    ...
    scoreboard players set #temp_angle temp 360000
    scoreboard players operation #temp_angle temp /= #temp_player_count temp
    execute store result storage santa_battle_core: Temp.Rotation float 0.001 run scoreboard players get #temp_angle temp
