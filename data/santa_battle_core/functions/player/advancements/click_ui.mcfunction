...
# チーム加入
    ...
    execute if entity @s[tag=vaDisplay_Team_Blue] as @a[tag=Temp.Target] run function santa_battle_core:game_main/phase1/team/join_blue
    execute if entity @s[tag=vaDisplay_Team_Green] as @a[tag=Temp.Target] run function santa_battle_core:game_main/phase1/team/join_green
    execute if entity @s[tag=vaDisplay_Team_Yellow] as @a[tag=Temp.Target] run function santa_battle_core:game_main/phase1/team/join_yellow
    execute if entity @s[tag=vaDisplay_Team_Ghost] as @a[tag=Temp.Target] run function santa_battle_core:game_main/phase1/team/join_ghost
