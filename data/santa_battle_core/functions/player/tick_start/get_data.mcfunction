...
# give @p written_book{display:{Name:'{"text":"サンタの掟","color":"green","italic":false}',Lore:['{"text":"サンタが守るべきルールが書かれた書物．","italic":false}']},SbcItemId:2,title:"",author:"",pages:['{"text":"掟その１\\n\\nサンタはソリに乗るもの。\\nベルを鳴らしてソリを呼び出すべし。\\n\\nソリを引く動物によって動きは大きく変わる。\\n自分に合う動物を探せ。"}','{"text":"掟その２\\n\\nサンタは孤高なる存在。\\n子供に夢を与える存在は一人で良い。\\n\\nプレゼントを投げ、ほかのサンタを蹴落とすべし。\\n\\n敵の動きを読み、上手く当てよ。"}','{"text":"掟その３\\n\\nサンタは秘密の存在。\\n決して地に降りてはいけない。\\n\\n地に降りた者はサンタの資格なし。\\n戦いのさなかであろうと、空を飛び続けるべし。"}','{"text":"掟その４\\n\\nソリは命。\\n\\nソリを飛び降り、敵の虚をつくのは有効な戦術である。\\n\\nただし、ソリは３回までしか呼び出せない。\\nソリを失ったサンタに待つのは、絶望のみ。"}','{"text":"掟その５\\n\\n道具は有効に活用すべし。\\n拾ったものはプレゼントボックスに保管しておき、いざという時に活用せよ。\\n\\n空に浮かぶ道具は急いで確保せよ。\\nただし、他のサンタに狙われぬよう注意せよ。"}']} 1