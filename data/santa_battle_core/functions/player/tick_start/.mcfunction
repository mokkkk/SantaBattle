...
# 無敵時間処理
    # 無敵エフェクト
        execute if entity @s[tag=!Player.Ghost] unless score #game_manager game.phase matches 4 if score @s player.invulnerable_timer matches 1.. run particle happy_villager ~ ~1 ~ 0.5 0.8 0.5 0 1 force
    # 減算
