...
# 移動速度計算用marker召喚
    $execute if entity @s[x_rotation=-45..45] positioned 0.0 0.0 0.0 positioned ^ ^ ^$(Speed) positioned ^ ^1 ^ run summon marker ~ ~ ~ {Tags:["Temp.Calc.PlayerSpeed"]}
    $execute unless entity @s[x_rotation=-45..45] positioned 0.0 0.0 0.0 positioned ^ ^ ^$(Speed) run summon marker ~ ~ ~ {Tags:["Temp.Calc.PlayerSpeed"]}
