...
# tp可能な場合は，tpする
    execute if entity @s[tag=!TpEnd] if block ^ ^ ^1 #santa_battle_core:no_collision positioned ^ ^ ^3 rotated ~ 0 run function santa_battle_core:player/sled/move/animal_tp
