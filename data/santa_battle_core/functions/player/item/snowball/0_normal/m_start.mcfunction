#> santa_battle_core:player/item/snowball/0_normal/m_start
#
# 雪玉 使用開始処理
...
# 弾召喚
    execute if entity @s[tag=!Player.OnSled] positioned ~ ~1.65 ~ run summon item_display ^ ^ ^1 {teleport_duration:3,Tags:["Temp.Start","Mob.Bullet","Mob.Bullet.Normal"],transformation:[0.5000f,0.0000f,0.0000f,-0.2500f,0.0000f,0.5000f,0.0000f,-0.2500f,0.0000f,0.0000f,0.5000f,-0.2500f,0.0000f,0.0000f,0.0000f,1.0000f],item:{id:"minecraft:chest",Count:1b}}
    execute if entity @s[tag=Player.OnSled] positioned ~ ~1.65 ~ run summon item_display ^ ^ ^ {teleport_duration:3,Tags:["Temp.Start","Mob.Bullet","Mob.Bullet.Normal"],transformation:[0.5000f,0.0000f,0.0000f,-0.2500f,0.0000f,0.5000f,0.0000f,-0.2500f,0.0000f,0.0000f,0.5000f,-0.2500f,0.0000f,0.0000f,0.0000f,1.0000f],item:{id:"minecraft:chest",Count:1b}}
...
# 重力加速度設定:0.9
    scoreboard players set @e[type=item_display,tag=Temp.Start,tag=Mob.Bullet] bullet.status.speed_g 900
