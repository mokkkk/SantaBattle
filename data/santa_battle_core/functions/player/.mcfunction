...
# バトル中：着地処理
    execute if entity @s[tag=!Player.Ghost,nbt={OnGround:1b}] if score #game_manager game.phase matches 3 unless block ~ ~-1 ~ white_stained_glass unless score @s player.invulnerable_timer matches 1.. run function santa_battle_core:player/landing/
